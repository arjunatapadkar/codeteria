...
const Playground = () => {
  ...
  const runCode = async () => {
    ...
    try {
      ...
      while (attempts < maxAttempts) {
        ...
        const statusResponse = await fetch(`https://judge0-ce.p.rapidapi.com/submissions/${token}?base64_encoded=true`, {
          method: 'GET',
          headers: {
            'X-RapidAPI-Host': 'judge0-ce.p.rapidapi.com',
            'X-RapidAPI-Key': JUDGE0_API_KEY,
  ...
  return (
    ...
    >
      <header className="bg-black bg-opacity-30 sticky top-0 z-50 backdrop-blur-md">
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-xl">Write, compile, and run your code instantly!</p>
        </motion.section>
      ...
      <footer className="bg-purple-900 bg-opacity-50 py-10 backdrop-blur-lg mt-12">
        <div className="container mx-auto px-6 text-center">
          <p className="text-gray-300">© 2024 Codeteria. All rights reserved.</p>
        </div>
      </footer>
    </motion.div>
  );
