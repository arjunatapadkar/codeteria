...
const IntSection = ({ card }) => {
	...
	return (
		<div onClick={()=>navigate(card.path)} className="relative flex  w-full lg:w-[40%] items-center mx-8 lg:mx-0 px-10 py-5  bg-white  gap-5 cursor-pointer hover:shadow-lg duration-150 overflow-hidden">
