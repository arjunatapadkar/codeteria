...
const IntSection = ({ card }) => {
	...
	return (
		<div
			...
			className={`${dark ? "bg-[#0F172A]" : "bg-white"} relative flex  w-full lg:w-[40%] items-center mx-8 lg:mx-0 px-10 py-5    gap-5 cursor-pointer hover:shadow-lg duration-150 overflow-hidden`}
		>
